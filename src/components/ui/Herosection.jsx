...
let HeroSection = () => {
  ...
  return (
    <>
      <div className="text-center gap-8 flex flex-col items-center p-6 pt-15 overflow-hidden ">
        <div className="">
          <h1 className="md:text-8xl text-2xl capitalize font-extrabold leading-relaxed text-primaryText">
            manage your finances <br />
            with intelligence
          </h1>
          <p className="text-secondaryText p-06 sm:px-20 md:px-40 lg:px-60 text-lg mb-5">
            ...
            dolores labore non aut totam ea blanditiis hic tempora ratione
            facere voluptates!
          </p>
          <div className="b  font-medium">
            <button className="bg-accentLight hover:bg-accentLight  p-2 sm:p-3">
              Get Started
            </button>
            ...
            <Link
              ...
              target="_blank"
            >
              <button className="bg-accentLight p-2 hover:bg-accentDark sm:p-3">
                Watch demo
              </button>
            </Link>
          </div>
